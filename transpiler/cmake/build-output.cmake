...
function(manage_symbolic_links POST_TARGET FRANKIE_COMMAND_NAME)
    if(WIN32)
        set(SYMBOLIC_LINKS_COMMAND_DELETE powershell -Command "Get-ChildItem -Path . -Attributes ReparsePoint | Remove-Item -Path {$_.FullName} -Force") 
        set(SYMBOLIC_LINKS_COMMAND_REMAKE echo "Windows already has a valid .exe main file!")
        set(SYMBOLIC_LINKS_COMMAND_EXTRA powershell -Command "Start-Process powershell -Verb RunAs -ArgumentList \\\"-Command cd '${CMAKE_RUNTIME_OUTPUT_DIRECTORY}' \; New-Item -Path ${FRANKIE_COMMAND_NAME}.exe -ItemType SymbolicLink -Value ${POST_TARGET}.exe \\\" ")
    else()
