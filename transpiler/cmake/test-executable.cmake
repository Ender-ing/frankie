...
elseif(${FRANKIE_BINARY_PLATFORM} STREQUAL "arm32")
    ...
    if(${ARM32_PROCESSORS} MATCHES ${CMAKE_SYSTEM_PROCESSOR} OR ${X32_PROCESSORS} MATCHES ${CMAKE_SYSTEM_PROCESSOR})
        set(NATIVE_SYSTEM_SUPPORTS_BINARIES TRUE)
    endif()
elseif(${FRANKIE_BINARY_PLATFORM} STREQUAL "x86_64")
    # Supports x86_64, and x86_32
    if(${X64_PROCESSORS} MATCHES ${CMAKE_SYSTEM_PROCESSOR} OR ${X32_PROCESSORS} MATCHES ${CMAKE_SYSTEM_PROCESSOR})
        set(NATIVE_SYSTEM_SUPPORTS_BINARIES TRUE)
    endif()
elseif(${FRANKIE_BINARY_PLATFORM} STREQUAL "x86_32")
    # Supports x86_32
    if(${X32_PROCESSORS} MATCHES ${CMAKE_SYSTEM_PROCESSOR})
        set(NATIVE_SYSTEM_SUPPORTS_BINARIES TRUE)
    endif()
else()
